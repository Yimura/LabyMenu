...
namespace YimMenu
{
	...
	struct LobbyManager_StaticFields
	{
		LobbyManager_o* instance;
	};

	struct LobbyManager_c
	{
		Il2CppClass_1 _1;
		LobbyManager_StaticFields* static_fields;
		Il2CppRGCTXData* rgctx_data;
		Il2CppClass_2 _2;
		LobbyManager_VTable vtable;
	};
}
